...
namespace Zysoft.ZyExternal.DAL.His
{
    ...
    public class BankTradeLogDal:DB
    {
            ...
            string registerType, string residenceNo, string icdCode, string safetyNO, string RateType, decimal LostCash)
        {
                ...
                {
                    string[] settleList = settleList1[2].Split('^');
                ...
                try
                    {
                        orcCmd.CommandText = @"
                                        insert into insur.insur_trade_log_jssyb(
                                            ...
                                            values(
			                                          ...
			                                          :insurance_register_no		                /*医保 门诊/住院流水号*/,
			                                          :insurance_register_no		                /*医保 门诊/住院流水号*/,
			                                          sysdate									    /*操作日期*/,
			                                          :cure_type									/*医疗类别*/,
			                                          0												/*HIS住院序号 门诊传0*/,
			                                          :residence_no				                    /*HIS门诊挂号号*/,
			                                          :icd_code									    /*病种编码*/,
			                                          :insurance_card_no			                /*医保卡号*/,
			                                          :rate_type					                /*HIS费别*/,
			                                          :lost_cash								    /*HIS总费用与医保总费用结算尾差*/);
                                        ";
                        OracleParameter[] parameters = {
                                        ...
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm3),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm4),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm5),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm6),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm7),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm8),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm9),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm10),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm11),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm12),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm13),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm14),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm15),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm16),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm17),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm18),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm19),
                                        new OracleParameter("ls_insure_out_paramm1", insure_out_paramm20),
                                        new OracleParameter("sick_id", sickId),
                                        new OracleParameter("insurance_register_no", insuranceNo),
                                        new OracleParameter("cure_type", registerType),
                                        new OracleParameter("residence_no", residenceNo),
                                        new OracleParameter("icd_code", icdCode),
                                        new OracleParameter("insurance_card_no", safetyNO),
                                        new OracleParameter("rate_type", RateType),
                                        new OracleParameter("lost_cash", LostCash)
            };
                    ...
                    string residenceNo, string RateType, decimal LostCash)
        {
            ...
            {
                string[] regList = regList1[8].Split('^');
            ...
            {
                string[] settleList = settleList1[8].Split('^');
